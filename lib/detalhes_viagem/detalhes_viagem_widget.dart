                                              ...
                                              Card(
                                                ...
                                                child: Row(
                                                  mainAxisSize:
                                                      MainAxisSize.max,
                                                  children: [
                                                    if (detalhesViagemViagensRecord
                                                            .visitado ==
                                                        false)
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: Text(
                                                                            'Viagem realizada'),
                                                                        content:
                                                                            Text('Você já visitou esse lugar mágico?'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                Navigator.pop(alertDialogContext, false),
                                                                            child:
                                                                                Text('Não, quem sabe um dia'),
                                                                          ),
                                                                          TextButton(
                                                                            onPressed: () =>
                                                                                Navigator.pop(alertDialogContext, true),
                                                                            child:
                                                                                Text('Sim! foi MARAVILHOSO'),
                                                                          ),
                                                                        ],
                                                                      );
                                                                    },
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Que demais!'),
                                                                  content: Text(
                                                                      'Viagem movida para lista VISITADOS'),
                                                                  actions: [
                                                                    TextButton(
                                                                      onPressed:
                                                                          () =>
                            ...
                            children: [
                              ...
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    12.0, 0.0, 0.0, 0.0),
                                child: Text(
                                  detalhesViagemViagensRecord.vontade
                                      .toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'viagemRef': serializeParam(
                                    detalhesViagemViagensRecord.reference,
